...
//		}
        ...
        while (cacheEntryConnectorHead != cacheEntryConnectorTail.getNext()) {
            System.out.println("lru.Entry: " + cacheEntryConnectorHead.getEntry());
            if (cacheEntryConnectorHead.getPrev() != null)
                System.out.println("\t Prev lru.Entry: " + cacheEntryConnectorHead.getPrev().getEntry());
            if (cacheEntryConnectorHead.getNext() != null)
                System.out.println("\t Next lru.Entry: " + cacheEntryConnectorHead.getNext().getEntry());
...
class CacheEntryConnector<K,V> {
    ...
    public String toString() {
        return "lru.CacheEntryConnector [entry=" + entry + ", prev=" + prev + ", next=" + next + "]";
    }
