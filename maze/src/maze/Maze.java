...
public class Maze {
    ...
    public static void main(String[] args) {
        ...
        mazeObj.solveMaze(maze1, new Cell(CellType.Entrance, 1, 0, true), new Cell(CellType.Exit, 4, 2, false));
        mazeObj.solveMaze(maze2, new Cell(CellType.Entrance, 0, 1, true), new Cell(CellType.Exit, 4, 2, false));
        mazeObj.solveMaze(maze3, new Cell(CellType.Entrance, 1, 0, true), new Cell(CellType.Exit, 4, 4, false));
        mazeObj.solveMaze(maze4, new Cell(CellType.Entrance, 0, 1, true), new Cell(CellType.Exit, 4, 2, false));
        mazeObj.solveMaze(maze5, new Cell(CellType.Entrance, 0, 1, true), new Cell(CellType.Exit, 4, 2, false));
        mazeObj.solveMaze(maze6, new Cell(CellType.Entrance, 0, 1, true), new Cell(CellType.Exit, 8, 7, false));
